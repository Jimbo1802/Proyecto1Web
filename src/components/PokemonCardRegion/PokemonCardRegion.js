...
// components/PokemonCard.js
function PokemonCardRegion({ pokemon }) {
    return (
        <Link to={`/regions/${pokemon.id}`} style={{ textDecoration: 'none', color: 'inherit', display: 'block', width: 'auto' }}>
...
export default PokemonCardRegion;
